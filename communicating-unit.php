...
<div class="mb-4 p-1 text-info">
        <p><a href="reports.php">Reports </a> >> <a href="#">Communicating data </a></p>
</div>
    ...
    <div class="col-lg-8">
        <div class="card border-left-info shadow h-100">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-xl-8">
                        <h6 class="m-0 font-weight-bold text-primary">Communicating Units </h6>                        
                    </div>
                    <div class="col-xl-4 text-right">                       
                        <a  id="ecportExcel" title="dataTable" alt="communicating_units" class="btn btn-success btn-circle btn-sm text-light">
