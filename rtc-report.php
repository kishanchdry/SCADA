...
<div class="mb-4 p-1 text-info">
    <p><a href="reports.php">Reports </a>  >> <a href="#">RTC Test </a></p>
</div>
    ...
    <div class="col-lg-12">
        <div class="card border-left-info shadow h-100">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-xl-8">
                        <h6 class="m-0 font-weight-bold text-primary">RTC Report </h6>
                    </div>
                    ...
                    <table class="table table-bordered table-sm" id="dataTable" width="100%" cellspacing="0">
                        <thead>
                            <tr class="bg-info text-light">
                                ...
                                <th>Zone</th>
                                <th>Address</th>
                                <th>Received RTC <small>(DD-HH-MM)</small></th>
                                <th>Current RTC <small>(DD-HH-MM)</small></th>
                                                ...
                                                for ($i=0;$i<$c;$i++) {
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><?php echo $unit->results()[$i]->rtc_dd.'-'. $unit->results()[$i]->rtc_hh.'-'. $unit->results()[$i]->rtc_mm;
                                                    ; ?></td>
                                                            <td><?php echo $c_rtc_dd.'-'. $c_rtc_hh.'-'. $c_rtc_mm;
                                                    ; ?></td>
                                                        </tr>
                                                        <?php
                                                }
