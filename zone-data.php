...
<div class="mb-4 p-1 text-info">
    <p>
        ...
        <a href="#">Zones <?php echo $_GET['z']; ?> </a>
    </p>
</div>
    ...
    <div class="col-xl-12 col-lg-12">
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                <div class="row">
                    <div class="col-xl-9">
                        <h6 class="m-0 font-weight-bold text-primary">Unit Details Of <?php echo $location; ?> Zone <?php echo $_GET['z']; ?></h6>
                    </div>
...
<script>
    ...
    $.ajax({
        ...
        type: "POST",
        data: { phase: phase_id, zone : zone_id},
        ...
        $.ajax({
                ...
                success: function(liveResult) {            
                    ...
                    for (var i = 0; i < dataObj.length;i++) {
                        ...
                        if(filter == 'all'){
                            tr +=   "<tr class='"+dataObj[i]['row_class']+"'><td>"+ sno +"</td><td>"+dataObj[i]['today_overflow']+"</td><td>"+dataObj[i]['weekly_overflow']+"</td><td>"+dataObj[i]['alarm_view']+"</td><td>"+dataObj[i]['currentflow']+"</td><td><a class='"+dataObj[i]['row_class']+"' href='unit-profile.php?u="+dataObj[i]['user_id']+"'>"+dataObj[i]['name']+"</a></td><td>"+dataObj[i]['comm_status_view']+"</td><td>"+dataObj[i]['last_comm']+"</td><td>"+dataObj[i]['address']+"</td><td>"+dataObj[i]['user_limit']+"</td><td>"+dataObj[i]['c_flow']+"</td><td>"+dataObj[i]['today_flow']+"</td><td>"+dataObj[i]['d1']+"</td><td>"+dataObj[i]['d2']+"</td><td>"+dataObj[i]['d3']+"</td><td>"+dataObj[i]['d4']+"</td><td>"+dataObj[i]['d5']+"</td><td>"+dataObj[i]['d6']+"</td><td>"+dataObj[i]['overload_view']+"</td><td>"+dataObj[i]['auto_manual_view']+"</td><td>"+dataObj[i]['panel_lock_view']+"</td></tr>";
                            sno++;
